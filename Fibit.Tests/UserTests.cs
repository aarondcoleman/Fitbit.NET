...
namespace Fibit.Tests
{
    ...
    public class UserTests
    {
        ...
        [Test]
        public void Can_Deserialize_Water_Data_Xml()
        {
            string content = File.ReadAllText(SampleData.PathFor("GetWater-WaterData.txt"));

            var deserializer = new RestSharp.Deserializers.XmlDeserializer();

            WaterData result = deserializer.Deserialize<WaterData>(new RestResponse() { Content = content });
        ...
        {
            string content = File.ReadAllText(SampleData.PathFor("GetWater-WaterData.json"));
        ...
        [Test]
        public void Can_Deserialize_Water_Log_Xml()
        {
            string content = File.ReadAllText(SampleData.PathFor("LogWater-WaterLog.txt"));
            ...
            Assert.IsNotNull(result);
            Assert.AreEqual(508726777, result.LogId);
