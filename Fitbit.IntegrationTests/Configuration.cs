...
namespace Fitbit.IntegrationTests
{
    public class Configuration
    {
        ...
        public readonly static string RequestTokenUrl = "https://api.fitbit.com/oauth/request_token";
        public readonly static string AccessTokenUrl = "https://api.fitbit.com/oauth/access_token";
        public readonly static string AuthorizeUrl = "https://www.fitbit.com/oauth/authorize";
