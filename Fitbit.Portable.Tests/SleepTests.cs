...
namespace Fitbit.Portable.Tests
{
    ...
    public class SleepTests
    {
        ...
        public async void GetSleepAsync_Success()
        {
            ...
            fakeResponseHandler.AddResponse(new Uri("https://api.fitbit.com/1/user/-/sleep/date/2014-10-17.json"), new HttpResponseMessage(HttpStatusCode.OK) { Content = new StringContent(content) });
        ...
        public async void GetUserProfileAsync_Failure_Errors()
        {
            ...
            var fakeResponseHandler = new FakeResponseHandler();
            fakeResponseHandler.AddResponse(new Uri("https://api.fitbit.com/1/user/ZXAS11/sleep/date/2014-11-11.json"), new HttpResponseMessage(HttpStatusCode.OK) { Content = new StringContent(content) });
