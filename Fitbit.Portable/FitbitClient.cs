...
namespace Fitbit.Api.Portable
{
    public class FitbitClient : IFitbitClient
    {
        ...
        public async Task<FitbitResponse<HeartActivitiesIntraday>> GetHeartRateIntraday(DateTime date, HeartRateResolution resolution)
        {
            ...
            string apiCall = String.Format("https://api.fitbit.com/1/user/-/activities/heart/date/{0}/{1}/{2}/time/00:00:00/23:59:59.json", date.ToString("yyyy-MM-dd"), date.ToString("yyyy-MM-dd"), resolutionText);
        ...
        public async Task<FitbitResponse<HeartActivitiesTimeSeries>> GetHeartRateTimeSeries(DateTime date, DateRangePeriod dateRangePeriod, string userId = null)
        {
            ...
            string apiCall = String.Format("https://api.fitbit.com/1/user/{0}/activities/heart/date/{1}/{2}.json", userId, date.ToString("yyyy-MM-dd"), dateRangePeriod.GetStringValue());
