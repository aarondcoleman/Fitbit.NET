...
namespace Fitbit.Api.Portable
{
    public interface IFitbitClient
    {
        ...
        Task<ActivityGoals> SetGoalsAsync(int caloriesOut = default(int), decimal distance = default(decimal), int floors = default(int), int steps = default(int), int activeMinutes = default(int), int activeZoneMinutes = default(int), GoalPeriod period = GoalPeriod.Daily);
        Task<ActivityGoals> GetGoalsAsync(GoalPeriod period);
        Task<SleepGoal> GetSleepGoalAsync();
        Task<WeightGoal> GetWeightGoalsAsync();
        Task<WeightGoal> SetWeightGoalAsync(DateTime startDate, double startWeight, double weight);
