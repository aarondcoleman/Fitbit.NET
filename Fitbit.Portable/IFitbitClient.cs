...
namespace Fitbit.Api.Portable
{
    public interface IFitbitClient
    {
        ...
        Task<ActivityGoals> SetGoalsAsync(GoalType goalType, Double value, GoalPeriod period = GoalPeriod.Daily);
        ...
        Task<List<CardioScoreSummary>> GetCardioScoreSummaryAsync(DateTime startDate, DateTime? endDate = null);
