...
namespace Fitbit.Api.Portable
{
    public interface IFitbitClient
    {
        ...
        Task<SleepLogListBase> GetSleepLogListAsync(DateTime beforeDate, DateTime afterDate, string sort,  string limit,
            int offset = 0, string encodedUserId = default(string));
