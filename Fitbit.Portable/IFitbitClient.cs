...
namespace Fitbit.Api.Portable
{
    ...
    {
	    Task<ActivitiesList> GetActivityListAsync(DateTime dateTime, DateTypeEnum dateType, SortEnum sort, int limit = 20, int offset = 0, string encodedUserId = default(string));
