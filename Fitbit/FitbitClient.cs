...
namespace Fitbit.Api
{
    ...
    public class FitbitClient : IFitbitClient
    {
        ...
        public WaterData GetWater(DateTime date, string userId)
        {
            ...
            string apiCall = String.Format("/1/user/{0}/foods/log/water/date/{1}.{2}", 
                userSignifier, 
        ...
        public WaterLog LogWater(DateTime date, WaterLog log, string userId)
        {
            ...
            string endPoint = string.Format("/1/user/{0}/foods/log/water.{1}", userSignifier, StringEnum.GetStringValue(responseType));
            RestRequest request = new RestRequest(endPoint, Method.POST);
        ...
        public void DeleteWaterLog(long logId, string userId)
        {
            ...
            string endPoint = string.Format("/1/user/{0}/foods/log/water/{1}.{2}", 
                userSignifier, 
                logId, 
                StringEnum.GetStringValue(responseType));
